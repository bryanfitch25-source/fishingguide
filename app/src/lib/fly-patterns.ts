// The pattern library.
//
// Every fly here is a real, documented pattern with a traceable origin — no invented
// names, no "variants" made up to pad a list. Where a fly has a known originator it is
// credited, because in this sport the provenance is half the point: the Green Machine and
// the Bomber are Miramichi flies, the Grey Ghost is Carrie Stevens' 1924 smelt imitation
// from Rangeley, the Clouser Minnow is Bob Clouser's from the late 1980s. Anything I could
// not stand behind was left out rather than guessed at.
//
...
// them beats making someone guess which group to look in.
...
export interface FlyPattern {
  ...
  when: string;
  note: string;
  /** Named tier or river of origin, where it's documented. */
  origin?: string;
...
const ATLANTIC_SALMON: FlyPattern[] = [
  ...
  },
  {
    ...
    sizes: "4 – 10",
    when: "General, summer",
    note: "A Maritime classic whose name is its own joke about salmon anglers arguing over patterns.",
  },
  {
    name: "Shady Lady",
    type: "Hairwing",
  ...
  },
  {
    ...
    note: "White wings set in a V, palmered brown hackle, red butt. An unmistakable silhouette and a Miramichi grilse favourite.",
    origin: "Maurice Ingalls, Miramichi",
  },
  {
    name: "Dungarvon",
    type: "Hairwing",
    sizes: "4 – 10",
    when: "Summer, general",
    note: "Named for the Dungarvon River, a Miramichi tributary. Local through and through.",
    origin: "Dungarvon River, New Brunswick",
  },
  {
  ...
  },
  {
    ...
    type: "Hairwing",
    sizes: "4 – 10",
    when: "Late summer, low water",
    note: "Golden pheasant and orange. A Newfoundland and Maritime favourite for bright conditions.",
  },
  {
    name: "Bear Hair Bug",
    type: "Bomber",
    ...
    note: "The buck-bug family the Green Machine belongs to — palmered hackle over a floss body, fished damp in the surface.",
  },
  {
    name: "White-Tailed Green Machine",
    type: "Bomber",
    sizes: "4 – 10",
    when: "Low clear water, bright day",
    note: "The Green Machine with a white tail for visibility. A common and long-established dressing rather than a novelty.",
  },
  {
    name: "Blue Charm (White Wing)",
    type: "Hairwing",
    sizes: "6 – 12",
    when: "Failing light, dusk",
    note: "The standard Blue Charm rewinged in white so you can track it in the last half-hour.",
  },
  {
    name: "Conrad",
    type: "Hairwing",
    sizes: "4 – 10",
    when: "General summer",
    note: "A documented Maritime hairwing that has kept its place in local boxes.",
  },
  {
    name: "Oriole",
    type: "Hairwing",
    sizes: "4 – 10",
    when: "Bright water",
    note: "Orange and black. Another of the long-lived Maritime dressings.",
  },
];
...
const BROOK_TROUT: FlyPattern[] = [
  ...
  { name: "Stimulator", type: "Dry", sizes: "8 – 16", when: "Summer, fast water", note: "Big and buoyant. Doubles as a stonefly, a hopper, and a strike indicator.", imitates: "Stonefly / large terrestrial", origin: "Randall Kaufmann" },
  ...
  // --- Terrestrials --------------------------------------------------------
  { name: "Foam Ant", type: "Terrestrial", sizes: "14 – 20", when: "Midsummer, overhanging banks", note: "Trout eat far more ants than anyone fishes. Worth a cast under every alder.", imitates: "Ant" },
  { name: "Foam Beetle", type: "Terrestrial", sizes: "12 – 18", when: "Hot, still afternoons", note: "Drops in with an audible plop, which is the point.", imitates: "Beetle" },
  ...
  { name: "Stonefly Nymph", type: "Nymph", sizes: "6 – 12", when: "Rocky, oxygenated water", note: "Big and heavy. Where stoneflies live, brook trout know them well.", imitates: "Stonefly nymph" },
  { name: "Caddis Pupa", type: "Nymph", sizes: "12 – 18", when: "Just before an evening caddis hatch", note: "The stage fish key on while everyone else is fishing the adult.", imitates: "Caddis pupa" },

  // --- Wets, the Maritime tradition ---------------------------------------
  { name: "Montreal", type: "Wet", sizes: "8 – 14", when: "Spring, coloured water", note: "A Canadian pattern developed for brook trout in the 1850s and still catching them.", origin: "Canada, 1850s" },
  ...
  { name: "Dark Montreal", type: "Wet", sizes: "8 – 14", when: "Tea-stained water", note: "The darker dressing of the Montreal, for bog-stained Maritime rivers.", origin: "Canada" },
  ...
  { name: "Black Ghost", type: "Streamer", sizes: "4 – 10", when: "Lakes and deep pools", note: "Black body, white wing. A New England smelt streamer that travelled north and stayed.", imitates: "Smelt", origin: "Herbert Welch, Maine" },
  ...
  { name: "Nine-Three", type: "Streamer", sizes: "2 – 8", when: "Landlocked salmon, cold water", note: "Green over white. Named for the nine-pound-three-ounce salmon it first took.", imitates: "Smelt", origin: "Herbie Welch, Maine" },
...
const STRIPED_BASS: FlyPattern[] = [
  { name: "Clouser Deep Minnow", type: "Saltwater", sizes: "2/0 – 4", when: "Anywhere, any tide", note: "Dumbbell eyes ride it hook-up over structure. Chartreuse/white first, olive/white second. Arguably the most effective striper fly ever tied.", imitates: "Baitfish", origin: "Bob Clouser, late 1980s" },
  ...
  { name: "Sand Eel", type: "Saltwater", sizes: "1/0 – 4", when: "Sand eels in the wash", note: "Long, thin, and unadorned. Sand eels are the Northumberland Strait's overlooked staple.", imitates: "Sand lance" },
  { name: "Gaspereau / Alewife pattern", type: "Saltwater", sizes: "2/0 – 1", when: "Spring, on the bait runs", note: "When the gaspereau run the Miramichi, matching them matters more than usual.", imitates: "Gaspereau (alewife)" },
  { name: "Smelt pattern", type: "Saltwater", sizes: "1/0 – 4", when: "Early spring, estuaries", note: "Smelt are the first real bait of the year in Maritime estuaries and the stripers know it.", imitates: "Rainbow smelt" },
  { name: "Black Deceiver", type: "Saltwater", sizes: "2/0 – 1", when: "Night fishing", note: "Solid black gives the strongest silhouette against a night sky. Counter-intuitive and correct.", imitates: "Silhouette" },
  { name: "Chartreuse and White Clouser", type: "Saltwater", sizes: "1/0 – 2", when: "Coloured water, tidal rivers", note: "The single colour combination to own if you own one.", imitates: "Baitfish" },
  { name: "Shrimp pattern", type: "Saltwater", sizes: "2 – 6", when: "Back-estuary, low light", note: "Small and subtle, for fish grubbing the flats rather than chasing bait.", imitates: "Grass shrimp" },
];

const SMALLMOUTH: FlyPattern[] = [
  { name: "Popper", type: "Topwater", sizes: "2 – 8", when: "Summer mornings and evenings", note: "The reason a lot of people own a 6 wt in the first place.", },
  ...
  { name: "Crayfish pattern", type: "Streamer", sizes: "4 – 8", when: "Rocky bottom, late summer", note: "Fished slow and on the bottom. Smallmouth eat more crayfish than anything else.", imitates: "Crayfish" },
  ...
  { name: "Hellgrammite pattern", type: "Nymph", sizes: "4 – 8", when: "Rocky rivers, all season", note: "Dobsonfly larvae live in exactly the water smallmouth do.", imitates: "Hellgrammite" },
];
...
const LANDLOCKED_AND_SEARUN: FlyPattern[] = [
  ...
  { name: "Black Ghost", type: "Streamer", sizes: "2 – 8", when: "Deep, cold water", note: "Black body, white wing, yellow hackle. Fishes well trolled or cast.", imitates: "Smelt", origin: "Herbert Welch, Maine" },
  { name: "Nine-Three", type: "Streamer", sizes: "2 – 8", when: "Spring, cold lakes", note: "Green over white — a landlocked salmon classic named for the fish that made its reputation.", imitates: "Smelt", origin: "Herbie Welch, Maine" },
...
const SHAD_AND_OTHER: FlyPattern[] = [
  { name: "Shad Dart", type: "Streamer", sizes: "4 – 8", when: "Spring shad run, on the swing", note: "Small, bright, weighted. Shad take flash and movement rather than imitation.", },
  { name: "Pink and Silver Shad Fly", type: "Streamer", sizes: "4 – 8", when: "Shad, mid-river current", note: "Pink is the traditional shad colour for reasons nobody has fully explained.", },
  { name: "Chartreuse Clouser (small)", type: "Streamer", sizes: "4 – 8", when: "Shad, mackerel, anything schooling", note: "Scaled down, it covers a surprising amount of Maritime water.", imitates: "Small baitfish" },
  { name: "Mackerel fly (silver tinsel)", type: "Saltwater", sizes: "2 – 6", when: "Summer, mackerel schools off the wharves", note: "Mackerel will hit almost anything bright and fast. A strip of tinsel on a hook does it.", imitates: "Small bait" },
  { name: "White Bucktail", type: "Saltwater", sizes: "1/0 – 4", when: "Anywhere, any schooling fish", note: "The simplest saltwater fly there is, and it still catches everything from mackerel to stripers.", imitates: "Generic baitfish" },
  { name: "Chain Pickerel Streamer", type: "Streamer", sizes: "1/0 – 4", when: "Weedy bays, summer", note: "Big, flashy, and tied on wire or heavy fluorocarbon — pickerel teeth end tippets.", imitates: "Small baitfish" },
];
...
export const TOTAL_PATTERNS = PATTERN_GROUPS.reduce((n, g) => n + g.patterns.length, 0);
