...
export function TideNowCard({
  ...
  return (
    ...
    >
      <p className="text-3xl sm:text-4xl font-bold tracking-tight text-brand-dark">
      ...
      <p className="mt-0.5 text-xs text-muted">
        ...
        {/* The "how" only needs saying once per screen — the curve's own caption
            carries it, so it's dropped on phones where it cost two whole lines. */}
      ...
      {weather && (
        <p className="mt-2 sm:mt-3 border-t border-border pt-2 sm:pt-3 text-sm text-muted">
